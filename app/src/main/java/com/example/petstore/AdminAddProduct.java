...
public class AdminAddProduct extends AppCompatActivity {
    ...
    private EditText InputProductName, InputProduct_Description, InputProductPrice;
...
private Uri ImageUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      ProductImagesRef = FirebaseStorage.getInstance().getReference().child("PetImages");
      ...
      InputProduct_Description = (EditText) findViewById(R.id.product_specification);
    ...
    private void ValidateProductData(){
        Description = InputProduct_Description.getText().toString();
        Price = InputProductPrice.getText().toString();
        pname = InputProductName.getText().toString();

        if(ImageUri == null){
            Toast.makeText(this, "Pet Image Is Required.", Toast.LENGTH_SHORT).show();
        }
            ...
            Toast.makeText(this, "Pet Price Is Required.", Toast.LENGTH_SHORT).show();
        }
        else {
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AdminAddProduct.this, "Product Image Saved To Database Successfully.", Toast.LENGTH_SHORT).show();

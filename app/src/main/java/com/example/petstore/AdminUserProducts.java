...
public class AdminUserProducts extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userIds = getIntent().getStringExtra("uid");
        productsList = findViewById(R.id.userproductsList);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Cart> options = new FirebaseRecyclerOptions.Builder<Cart>()
                .setQuery(cartListRef.child("Admin View").child(userIds).child("Pets"),Cart.class).build();

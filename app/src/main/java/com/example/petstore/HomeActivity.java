...
public class HomeActivity extends AppCompatActivity implements AppBarConfiguration.OnNavigateUpListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuItem CategoryItem = navigationView.getMenu().findItem(R.id.nav_categories);
        ...
        MenuItem search = navigationView.getMenu().findItem(R.id.nav_orders);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (item.getItemId() == R.id.carticon) {
            Intent intent = new Intent(HomeActivity.this, CartActivity.class);
            startActivity(intent);
        }
